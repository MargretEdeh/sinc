...
const HeroSection: React.FunctionComponent<IHeroSectionProps> = (props) => {
  return (
    <main className="flex md:h-[500px] md:px-20 md:py-20   ">
      <article className=" md:w-[40%]  bg-white flex flex-col px-3 py-5 items-center justify-center md:items-start md:justify-start gap-3 ">
        <h2 className=" text-xl text-center md:text-start md:text-3xl font-semibold md:leading-10">
      ...
      <Image className=" filter opacity-20 md:opacity-100 end-0 absolute top-0" src={hero} alt="Hero"/>
    </main>
  );
};
